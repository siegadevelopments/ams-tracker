...
const CORPORATE_ENGINEERS: CorporateEngineer[] = [
  ...
  { name: "Asher M. Taylor", email: "asher.m.taylor@ark.co.th", role: "Team Lead", domain: "Finance", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  ...
  { name: "Maria Yilmaz", email: "maria.yilmaz@ark.co.th", role: "Team Lead", domain: "Supply chain and Planning Domain", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  ...
  { name: "Arnel Maala", email: "arnel.maala@ark.co.th", role: "Team Lead", domain: "Store Ops, Sales", dutyRole: "SUPPORT", shiftType: "NEXT" },
  { name: "Mohammad Bari", email: "mohammad.bari@ark.co.th", role: "Team Lead", domain: "Integration and Middleware Domain", dutyRole: "SUPPORT", shiftType: "NEXT" },
