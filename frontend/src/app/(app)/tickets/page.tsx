...
const CORPORATE_ENGINEERS: CorporateEngineer[] = [
  { name: "Ernest Siega", email: "ernest.siega@ark.co.th", role: "AMS Head", domain: "Supply chain and Planning Domain", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  { name: "Steven Ybanez", email: "steven.ybanez@ark.co.th", role: "Team Lead", domain: "Supply chain and Planning Domain", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  { name: "Jonathan Morales", email: "jonathan.morales@ark.co.th", role: "Team Lead", domain: "Finance", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  { name: "Kyle Amaquin", email: "kyle.amaquin@ark.co.th", role: "Team Lead", domain: "Store Ops, Sales", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  { name: "Claire Acula", email: "claire.acula@ark.co.th", role: "Team Lead", domain: "Buy and Merchandise Domain", dutyRole: "SUPPORT", shiftType: "NEXT" },
  { name: "Arnel Maala", email: "arnel.maala@ark.co.th", role: "Team Lead", domain: "Integration and Middleware Domain", dutyRole: "SUPPORT", shiftType: "NEXT" },
  ...
  { name: "Asher M. Taylor", email: "asher.m.taylor@ark.co.th", role: "AMS Engineer", domain: "Finance", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  ...
  { name: "Maria Yilmaz", email: "maria.yilmaz@ark.co.th", role: "AMS Engineer", domain: "Supply chain and Planning Domain", dutyRole: "SUPPORT", shiftType: "CURRENT" },
  ...
  { name: "Mohammad Bari", email: "mohammad.bari@ark.co.th", role: "AMS Engineer", domain: "Integration and Middleware Domain", dutyRole: "SUPPORT", shiftType: "NEXT" },
