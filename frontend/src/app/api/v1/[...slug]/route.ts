...
/**
 * Production API Handler for /api/v1/*
 * Serves corporate user directory (@ark.co.th) for Lotus's AMS team.
 * Roles strictly restricted to: AMS Head, Team Lead, and Support Engineer.
 */
...
let teamMembersStore: any[] = [
  ...
  {
    id: "usr-002",
    email: "arthur.myles@ark.co.th",
    first_name: "Arthur",
    last_name: "Myles",
    employee_id: "ARK-ENG-102",
    role: "SUPPORT_ENGINEER",
  ...
  {
    id: "usr-003",
    email: "asher.m.taylor@ark.co.th",
    first_name: "Asher M.",
    last_name: "Taylor",
    employee_id: "ARK-TL-103",
    role: "TEAM_LEAD",
    domain: "Finance",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-004",
    email: "ed.wong@ark.co.th",
    first_name: "Ed",
    last_name: "Wong",
    employee_id: "ARK-ENG-104",
    role: "SUPPORT_ENGINEER",
  ...
  {
    id: "usr-005",
    email: "essam.nabil@ark.co.th",
    first_name: "Essam",
    last_name: "Nabil",
    employee_id: "ARK-ENG-105",
    role: "SUPPORT_ENGINEER",
  ...
  {
    id: "usr-006",
    email: "fred.valdez@ark.co.th",
    first_name: "Fred",
    last_name: "Valdez",
    employee_id: "ARK-ENG-106",
    role: "SUPPORT_ENGINEER",
    domain: "Supply chain and Planning Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-007",
    email: "gee.isaac@ark.co.th",
    first_name: "Gee",
    last_name: "Isaac",
    employee_id: "ARK-ENG-107",
    role: "SUPPORT_ENGINEER",
    domain: "Store Ops, Sales",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-008",
    email: "maria.yilmaz@ark.co.th",
    first_name: "Maria",
    last_name: "Yilmaz",
    employee_id: "ARK-TL-108",
    role: "TEAM_LEAD",
    domain: "Supply chain and Planning Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-009",
    email: "nielsen.perez@ark.co.th",
    first_name: "Nielsen",
    last_name: "Perez",
    employee_id: "ARK-ENG-109",
    role: "SUPPORT_ENGINEER",
    domain: "Finance",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-010",
    email: "sean.reed@ark.co.th",
    first_name: "Sean",
    last_name: "Reed",
    employee_id: "ARK-ENG-110",
    role: "SUPPORT_ENGINEER",
    domain: "Integration and Middleware Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-011",
    email: "shaun.hao@ark.co.th",
    first_name: "Shaun",
    last_name: "Hao",
    employee_id: "ARK-ENG-111",
    role: "SUPPORT_ENGINEER",
    domain: "Buy and Merchandise Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-012",
    email: "zack.chase@ark.co.th",
    first_name: "Zack",
    last_name: "Chase",
    employee_id: "ARK-ENG-112",
    role: "SUPPORT_ENGINEER",
    domain: "Store Ops, Sales",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-013",
    email: "bjismael@ark.co.th",
    first_name: "BJ",
    last_name: "Ismael",
    employee_id: "ARK-ENG-113",
    role: "SUPPORT_ENGINEER",
    domain: "Supply chain and Planning Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-014",
    email: "arnel.maala@ark.co.th",
    first_name: "Arnel",
    last_name: "Maala",
    employee_id: "ARK-TL-114",
    role: "TEAM_LEAD",
    domain: "Store Ops, Sales",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-015",
    email: "mohammad.bari@ark.co.th",
    first_name: "Mohammad",
    last_name: "Bari",
    employee_id: "ARK-TL-115",
    role: "TEAM_LEAD",
    domain: "Integration and Middleware Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-016",
    email: "claire.acula@ark.co.th",
    first_name: "Claire",
    last_name: "Acula",
    employee_id: "ARK-TL-116",
    role: "TEAM_LEAD",
    domain: "Buy and Merchandise Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-017",
    email: "jonathan.morales@ark.co.th",
    first_name: "Jonathan",
    last_name: "Morales",
    employee_id: "ARK-ENG-117",
    role: "SUPPORT_ENGINEER",
    domain: "Finance",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-018",
    email: "patrick.cinco@ark.co.th",
    first_name: "Patrick",
    last_name: "Cinco",
    employee_id: "ARK-ENG-118",
    role: "SUPPORT_ENGINEER",
    domain: "Integration and Middleware Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
  ...
  {
    id: "usr-019",
    email: "vryll.atilano@ark.co.th",
    first_name: "Vryll",
    last_name: "Atilano",
    employee_id: "ARK-ENG-119",
    role: "SUPPORT_ENGINEER",
    domain: "Buy and Merchandise Domain",
    lotuss_name: "LTT",
    timezone: "Asia/Bangkok",
...
export async function GET(request: NextRequest) {
  ...
  if (path === "/reports/sla" || path === "/reports/sla/") {
    return NextResponse.json({
      data: {
        overall_compliance_percent: 98.6,
