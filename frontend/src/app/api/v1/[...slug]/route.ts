...
let currentShiftState: any = {
  ...
  scheduled_start_utc: "2026-08-23T08:00:00Z",
  scheduled_end_utc: "2026-08-23T17:00:00Z",
  ...
  data: [
    {
      ...
      description: "Shift 1 = 8AM-5PM Primary Shift",
      is_active: true,
    },
    {
      id: "st-2",
      ...
      crosses_midnight: false,
      grace_period_minutes: 15,
      description: "Shift 2 = 2PM-11PM Evening Shift",
      is_active: true,
    },
    {
      id: "st-3",
      ...
      grace_period_minutes: 15,
      description: "Shift 3 = 11PM-8AM Overnight Shift",
      is_active: true,
    },
    {
      id: "st-4",
      ...
      crosses_midnight: false,
      grace_period_minutes: 15,
      description: "Training = 8AM-5PM Skill Enhancement",
      is_active: true,
    },
  ],
};
